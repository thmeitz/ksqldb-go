...
// IValuesContext is an autogenerated mock type for the IValuesContext type
type IValuesContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IValuesContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IValuesContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IValuesContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IValuesContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IValuesContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IValuesContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IValuesContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IValuesContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IValuesContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IValuesContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IValuesContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IValuesContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IValuesContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IValuesContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IValuesContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IValuesContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IValuesContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IValuesContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IValuesContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IValuesContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IValuesContext) GetText() string {
	ret := _m.Called()
...
func (_m *IValuesContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsValuesContext provides a mock function with given fields:
func (_m *IValuesContext) IsValuesContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IValuesContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IValuesContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IValuesContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IValuesContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IValuesContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IValuesContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IValuesContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IValuesContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IValuesContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
