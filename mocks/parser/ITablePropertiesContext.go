...
// ITablePropertiesContext is an autogenerated mock type for the ITablePropertiesContext type
type ITablePropertiesContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ITablePropertiesContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ITablePropertiesContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ITablePropertiesContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ITablePropertiesContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ITablePropertiesContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ITablePropertiesContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ITablePropertiesContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ITablePropertiesContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) GetText() string {
	ret := _m.Called()
...
func (_m *ITablePropertiesContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsTablePropertiesContext provides a mock function with given fields:
func (_m *ITablePropertiesContext) IsTablePropertiesContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ITablePropertiesContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ITablePropertiesContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ITablePropertiesContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ITablePropertiesContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ITablePropertiesContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ITablePropertiesContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ITablePropertiesContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ITablePropertiesContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ITablePropertiesContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
