...
// IFunctionArgumentContext is an autogenerated mock type for the IFunctionArgumentContext type
type IFunctionArgumentContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IFunctionArgumentContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IFunctionArgumentContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IFunctionArgumentContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IFunctionArgumentContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IFunctionArgumentContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IFunctionArgumentContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IFunctionArgumentContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IFunctionArgumentContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) GetText() string {
	ret := _m.Called()
...
func (_m *IFunctionArgumentContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsFunctionArgumentContext provides a mock function with given fields:
func (_m *IFunctionArgumentContext) IsFunctionArgumentContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IFunctionArgumentContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IFunctionArgumentContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IFunctionArgumentContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IFunctionArgumentContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IFunctionArgumentContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IFunctionArgumentContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IFunctionArgumentContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IFunctionArgumentContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IFunctionArgumentContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
