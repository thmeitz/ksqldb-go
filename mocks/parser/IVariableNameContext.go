...
// IVariableNameContext is an autogenerated mock type for the IVariableNameContext type
type IVariableNameContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IVariableNameContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IVariableNameContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IVariableNameContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IVariableNameContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IVariableNameContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IVariableNameContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IVariableNameContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IVariableNameContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IVariableNameContext) GetText() string {
	ret := _m.Called()
...
func (_m *IVariableNameContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsVariableNameContext provides a mock function with given fields:
func (_m *IVariableNameContext) IsVariableNameContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IVariableNameContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IVariableNameContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IVariableNameContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IVariableNameContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IVariableNameContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IVariableNameContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IVariableNameContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IVariableNameContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IVariableNameContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
