...
// ISingleExpressionContext is an autogenerated mock type for the ISingleExpressionContext type
type ISingleExpressionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ISingleExpressionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ISingleExpressionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ISingleExpressionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ISingleExpressionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ISingleExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ISingleExpressionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ISingleExpressionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ISingleExpressionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) GetText() string {
	ret := _m.Called()
...
func (_m *ISingleExpressionContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsSingleExpressionContext provides a mock function with given fields:
func (_m *ISingleExpressionContext) IsSingleExpressionContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ISingleExpressionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ISingleExpressionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ISingleExpressionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ISingleExpressionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ISingleExpressionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ISingleExpressionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ISingleExpressionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ISingleExpressionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ISingleExpressionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
