...
// IRetentionClauseContext is an autogenerated mock type for the IRetentionClauseContext type
type IRetentionClauseContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IRetentionClauseContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IRetentionClauseContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IRetentionClauseContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IRetentionClauseContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IRetentionClauseContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IRetentionClauseContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IRetentionClauseContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IRetentionClauseContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) GetText() string {
	ret := _m.Called()
...
func (_m *IRetentionClauseContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsRetentionClauseContext provides a mock function with given fields:
func (_m *IRetentionClauseContext) IsRetentionClauseContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IRetentionClauseContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IRetentionClauseContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IRetentionClauseContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IRetentionClauseContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IRetentionClauseContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IRetentionClauseContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IRetentionClauseContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IRetentionClauseContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IRetentionClauseContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
