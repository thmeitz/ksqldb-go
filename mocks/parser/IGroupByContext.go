...
// IGroupByContext is an autogenerated mock type for the IGroupByContext type
type IGroupByContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IGroupByContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IGroupByContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IGroupByContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IGroupByContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IGroupByContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IGroupByContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IGroupByContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IGroupByContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IGroupByContext) GetText() string {
	ret := _m.Called()
...
func (_m *IGroupByContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsGroupByContext provides a mock function with given fields:
func (_m *IGroupByContext) IsGroupByContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IGroupByContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IGroupByContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IGroupByContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IGroupByContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IGroupByContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IGroupByContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IGroupByContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IGroupByContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IGroupByContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
