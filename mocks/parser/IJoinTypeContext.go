...
// IJoinTypeContext is an autogenerated mock type for the IJoinTypeContext type
type IJoinTypeContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IJoinTypeContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IJoinTypeContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IJoinTypeContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IJoinTypeContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IJoinTypeContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IJoinTypeContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IJoinTypeContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IJoinTypeContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) GetText() string {
	ret := _m.Called()
...
func (_m *IJoinTypeContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsJoinTypeContext provides a mock function with given fields:
func (_m *IJoinTypeContext) IsJoinTypeContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IJoinTypeContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IJoinTypeContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IJoinTypeContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IJoinTypeContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IJoinTypeContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IJoinTypeContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IJoinTypeContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IJoinTypeContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IJoinTypeContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
