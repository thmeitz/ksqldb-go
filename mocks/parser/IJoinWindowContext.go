...
// IJoinWindowContext is an autogenerated mock type for the IJoinWindowContext type
type IJoinWindowContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IJoinWindowContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IJoinWindowContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IJoinWindowContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IJoinWindowContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IJoinWindowContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IJoinWindowContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IJoinWindowContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IJoinWindowContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) GetText() string {
	ret := _m.Called()
...
func (_m *IJoinWindowContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsJoinWindowContext provides a mock function with given fields:
func (_m *IJoinWindowContext) IsJoinWindowContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IJoinWindowContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IJoinWindowContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IJoinWindowContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IJoinWindowContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IJoinWindowContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IJoinWindowContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IJoinWindowContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IJoinWindowContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IJoinWindowContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
