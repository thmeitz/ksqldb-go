...
// IWindowUnitContext is an autogenerated mock type for the IWindowUnitContext type
type IWindowUnitContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IWindowUnitContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IWindowUnitContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IWindowUnitContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IWindowUnitContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IWindowUnitContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IWindowUnitContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IWindowUnitContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IWindowUnitContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) GetText() string {
	ret := _m.Called()
...
func (_m *IWindowUnitContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsWindowUnitContext provides a mock function with given fields:
func (_m *IWindowUnitContext) IsWindowUnitContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IWindowUnitContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IWindowUnitContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IWindowUnitContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IWindowUnitContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IWindowUnitContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IWindowUnitContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IWindowUnitContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IWindowUnitContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IWindowUnitContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
