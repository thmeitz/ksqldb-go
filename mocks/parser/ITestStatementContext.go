...
// ITestStatementContext is an autogenerated mock type for the ITestStatementContext type
type ITestStatementContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ITestStatementContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ITestStatementContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ITestStatementContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ITestStatementContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ITestStatementContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ITestStatementContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ITestStatementContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ITestStatementContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ITestStatementContext) GetText() string {
	ret := _m.Called()
...
func (_m *ITestStatementContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsTestStatementContext provides a mock function with given fields:
func (_m *ITestStatementContext) IsTestStatementContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ITestStatementContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ITestStatementContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ITestStatementContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ITestStatementContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ITestStatementContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ITestStatementContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ITestStatementContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ITestStatementContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ITestStatementContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
