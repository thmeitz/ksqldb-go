...
// IAliasedRelationContext is an autogenerated mock type for the IAliasedRelationContext type
type IAliasedRelationContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IAliasedRelationContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IAliasedRelationContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IAliasedRelationContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IAliasedRelationContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IAliasedRelationContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IAliasedRelationContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IAliasedRelationContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IAliasedRelationContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) GetText() string {
	ret := _m.Called()
...
// IsAliasedRelationContext provides a mock function with given fields:
func (_m *IAliasedRelationContext) IsAliasedRelationContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IAliasedRelationContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IAliasedRelationContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IAliasedRelationContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IAliasedRelationContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IAliasedRelationContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IAliasedRelationContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IAliasedRelationContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IAliasedRelationContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IAliasedRelationContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IAliasedRelationContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
