...
// IColumnsContext is an autogenerated mock type for the IColumnsContext type
type IColumnsContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IColumnsContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IColumnsContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IColumnsContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IColumnsContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IColumnsContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IColumnsContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IColumnsContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IColumnsContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IColumnsContext) GetText() string {
	ret := _m.Called()
...
// IsColumnsContext provides a mock function with given fields:
func (_m *IColumnsContext) IsColumnsContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IColumnsContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IColumnsContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IColumnsContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IColumnsContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IColumnsContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IColumnsContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IColumnsContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IColumnsContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IColumnsContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IColumnsContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
