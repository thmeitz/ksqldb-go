...
// IGracePeriodClauseContext is an autogenerated mock type for the IGracePeriodClauseContext type
type IGracePeriodClauseContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IGracePeriodClauseContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IGracePeriodClauseContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IGracePeriodClauseContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IGracePeriodClauseContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IGracePeriodClauseContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IGracePeriodClauseContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IGracePeriodClauseContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IGracePeriodClauseContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) GetText() string {
	ret := _m.Called()
...
func (_m *IGracePeriodClauseContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsGracePeriodClauseContext provides a mock function with given fields:
func (_m *IGracePeriodClauseContext) IsGracePeriodClauseContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IGracePeriodClauseContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IGracePeriodClauseContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IGracePeriodClauseContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IGracePeriodClauseContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IGracePeriodClauseContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IGracePeriodClauseContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IGracePeriodClauseContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IGracePeriodClauseContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IGracePeriodClauseContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
