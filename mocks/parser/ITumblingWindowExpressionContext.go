...
// ITumblingWindowExpressionContext is an autogenerated mock type for the ITumblingWindowExpressionContext type
type ITumblingWindowExpressionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ITumblingWindowExpressionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ITumblingWindowExpressionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ITumblingWindowExpressionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ITumblingWindowExpressionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ITumblingWindowExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ITumblingWindowExpressionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ITumblingWindowExpressionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ITumblingWindowExpressionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) GetText() string {
	ret := _m.Called()
...
func (_m *ITumblingWindowExpressionContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsTumblingWindowExpressionContext provides a mock function with given fields:
func (_m *ITumblingWindowExpressionContext) IsTumblingWindowExpressionContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ITumblingWindowExpressionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ITumblingWindowExpressionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ITumblingWindowExpressionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ITumblingWindowExpressionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ITumblingWindowExpressionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ITumblingWindowExpressionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ITumblingWindowExpressionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ITumblingWindowExpressionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ITumblingWindowExpressionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
