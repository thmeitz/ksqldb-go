...
// INonReservedContext is an autogenerated mock type for the INonReservedContext type
type INonReservedContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *INonReservedContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *INonReservedContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *INonReservedContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *INonReservedContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *INonReservedContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *INonReservedContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *INonReservedContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *INonReservedContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *INonReservedContext) GetText() string {
	ret := _m.Called()
...
func (_m *INonReservedContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsNonReservedContext provides a mock function with given fields:
func (_m *INonReservedContext) IsNonReservedContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *INonReservedContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *INonReservedContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *INonReservedContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *INonReservedContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *INonReservedContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *INonReservedContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *INonReservedContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *INonReservedContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *INonReservedContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
