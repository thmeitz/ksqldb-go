...
// ILiteralContext is an autogenerated mock type for the ILiteralContext type
type ILiteralContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ILiteralContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ILiteralContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ILiteralContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ILiteralContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ILiteralContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ILiteralContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ILiteralContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ILiteralContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ILiteralContext) GetText() string {
	ret := _m.Called()
...
func (_m *ILiteralContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsLiteralContext provides a mock function with given fields:
func (_m *ILiteralContext) IsLiteralContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ILiteralContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ILiteralContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ILiteralContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ILiteralContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ILiteralContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ILiteralContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ILiteralContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ILiteralContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ILiteralContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
