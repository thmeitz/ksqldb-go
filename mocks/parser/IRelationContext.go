...
// IRelationContext is an autogenerated mock type for the IRelationContext type
type IRelationContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IRelationContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IRelationContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IRelationContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IRelationContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IRelationContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IRelationContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IRelationContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IRelationContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IRelationContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IRelationContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IRelationContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IRelationContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IRelationContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IRelationContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IRelationContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IRelationContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IRelationContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IRelationContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IRelationContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IRelationContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IRelationContext) GetText() string {
	ret := _m.Called()
...
func (_m *IRelationContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsRelationContext provides a mock function with given fields:
func (_m *IRelationContext) IsRelationContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IRelationContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IRelationContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IRelationContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IRelationContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IRelationContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IRelationContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IRelationContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IRelationContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IRelationContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
