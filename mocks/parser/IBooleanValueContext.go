...
// IBooleanValueContext is an autogenerated mock type for the IBooleanValueContext type
type IBooleanValueContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IBooleanValueContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IBooleanValueContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IBooleanValueContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IBooleanValueContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IBooleanValueContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IBooleanValueContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IBooleanValueContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IBooleanValueContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) GetText() string {
	ret := _m.Called()
...
// IsBooleanValueContext provides a mock function with given fields:
func (_m *IBooleanValueContext) IsBooleanValueContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IBooleanValueContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IBooleanValueContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IBooleanValueContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IBooleanValueContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IBooleanValueContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IBooleanValueContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IBooleanValueContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IBooleanValueContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IBooleanValueContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IBooleanValueContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
