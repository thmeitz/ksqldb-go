...
// IIdentifierContext is an autogenerated mock type for the IIdentifierContext type
type IIdentifierContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IIdentifierContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IIdentifierContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IIdentifierContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IIdentifierContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IIdentifierContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IIdentifierContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IIdentifierContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IIdentifierContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IIdentifierContext) GetText() string {
	ret := _m.Called()
...
func (_m *IIdentifierContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsIdentifierContext provides a mock function with given fields:
func (_m *IIdentifierContext) IsIdentifierContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IIdentifierContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IIdentifierContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IIdentifierContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IIdentifierContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IIdentifierContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IIdentifierContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IIdentifierContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IIdentifierContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IIdentifierContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
