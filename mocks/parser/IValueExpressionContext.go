...
// IValueExpressionContext is an autogenerated mock type for the IValueExpressionContext type
type IValueExpressionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IValueExpressionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IValueExpressionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IValueExpressionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IValueExpressionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IValueExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IValueExpressionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IValueExpressionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IValueExpressionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) GetText() string {
	ret := _m.Called()
...
func (_m *IValueExpressionContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsValueExpressionContext provides a mock function with given fields:
func (_m *IValueExpressionContext) IsValueExpressionContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IValueExpressionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IValueExpressionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IValueExpressionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IValueExpressionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IValueExpressionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IValueExpressionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IValueExpressionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IValueExpressionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IValueExpressionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
