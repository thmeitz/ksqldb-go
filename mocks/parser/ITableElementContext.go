...
// ITableElementContext is an autogenerated mock type for the ITableElementContext type
type ITableElementContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ITableElementContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ITableElementContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ITableElementContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ITableElementContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ITableElementContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ITableElementContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ITableElementContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ITableElementContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ITableElementContext) GetText() string {
	ret := _m.Called()
...
func (_m *ITableElementContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsTableElementContext provides a mock function with given fields:
func (_m *ITableElementContext) IsTableElementContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ITableElementContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ITableElementContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ITableElementContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ITableElementContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ITableElementContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ITableElementContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ITableElementContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ITableElementContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ITableElementContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
