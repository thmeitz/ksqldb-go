...
// IRelationPrimaryContext is an autogenerated mock type for the IRelationPrimaryContext type
type IRelationPrimaryContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IRelationPrimaryContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IRelationPrimaryContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IRelationPrimaryContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IRelationPrimaryContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IRelationPrimaryContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IRelationPrimaryContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IRelationPrimaryContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IRelationPrimaryContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) GetText() string {
	ret := _m.Called()
...
func (_m *IRelationPrimaryContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsRelationPrimaryContext provides a mock function with given fields:
func (_m *IRelationPrimaryContext) IsRelationPrimaryContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IRelationPrimaryContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IRelationPrimaryContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IRelationPrimaryContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IRelationPrimaryContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IRelationPrimaryContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IRelationPrimaryContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IRelationPrimaryContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IRelationPrimaryContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IRelationPrimaryContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
