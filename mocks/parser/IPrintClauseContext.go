...
// IPrintClauseContext is an autogenerated mock type for the IPrintClauseContext type
type IPrintClauseContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IPrintClauseContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IPrintClauseContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IPrintClauseContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IPrintClauseContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IPrintClauseContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IPrintClauseContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IPrintClauseContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IPrintClauseContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) GetText() string {
	ret := _m.Called()
...
func (_m *IPrintClauseContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsPrintClauseContext provides a mock function with given fields:
func (_m *IPrintClauseContext) IsPrintClauseContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IPrintClauseContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IPrintClauseContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IPrintClauseContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IPrintClauseContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IPrintClauseContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IPrintClauseContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IPrintClauseContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IPrintClauseContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IPrintClauseContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
