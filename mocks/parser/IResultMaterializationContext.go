...
// IResultMaterializationContext is an autogenerated mock type for the IResultMaterializationContext type
type IResultMaterializationContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IResultMaterializationContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IResultMaterializationContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IResultMaterializationContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IResultMaterializationContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IResultMaterializationContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IResultMaterializationContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IResultMaterializationContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IResultMaterializationContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) GetText() string {
	ret := _m.Called()
...
func (_m *IResultMaterializationContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsResultMaterializationContext provides a mock function with given fields:
func (_m *IResultMaterializationContext) IsResultMaterializationContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IResultMaterializationContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IResultMaterializationContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IResultMaterializationContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IResultMaterializationContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IResultMaterializationContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IResultMaterializationContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IResultMaterializationContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IResultMaterializationContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IResultMaterializationContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
