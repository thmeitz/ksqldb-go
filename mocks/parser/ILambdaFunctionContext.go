...
// ILambdaFunctionContext is an autogenerated mock type for the ILambdaFunctionContext type
type ILambdaFunctionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ILambdaFunctionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ILambdaFunctionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ILambdaFunctionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ILambdaFunctionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ILambdaFunctionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ILambdaFunctionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ILambdaFunctionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ILambdaFunctionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) GetText() string {
	ret := _m.Called()
...
func (_m *ILambdaFunctionContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsLambdaFunctionContext provides a mock function with given fields:
func (_m *ILambdaFunctionContext) IsLambdaFunctionContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ILambdaFunctionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ILambdaFunctionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ILambdaFunctionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ILambdaFunctionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ILambdaFunctionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ILambdaFunctionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ILambdaFunctionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ILambdaFunctionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ILambdaFunctionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
