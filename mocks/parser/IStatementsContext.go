...
// IStatementsContext is an autogenerated mock type for the IStatementsContext type
type IStatementsContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IStatementsContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IStatementsContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IStatementsContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IStatementsContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IStatementsContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IStatementsContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IStatementsContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IStatementsContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IStatementsContext) GetText() string {
	ret := _m.Called()
...
func (_m *IStatementsContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsStatementsContext provides a mock function with given fields:
func (_m *IStatementsContext) IsStatementsContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IStatementsContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IStatementsContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IStatementsContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IStatementsContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IStatementsContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IStatementsContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IStatementsContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IStatementsContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IStatementsContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
