...
// IJoinCriteriaContext is an autogenerated mock type for the IJoinCriteriaContext type
type IJoinCriteriaContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IJoinCriteriaContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IJoinCriteriaContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IJoinCriteriaContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IJoinCriteriaContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IJoinCriteriaContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IJoinCriteriaContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IJoinCriteriaContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IJoinCriteriaContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) GetText() string {
	ret := _m.Called()
...
func (_m *IJoinCriteriaContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsJoinCriteriaContext provides a mock function with given fields:
func (_m *IJoinCriteriaContext) IsJoinCriteriaContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IJoinCriteriaContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IJoinCriteriaContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IJoinCriteriaContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IJoinCriteriaContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IJoinCriteriaContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IJoinCriteriaContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IJoinCriteriaContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IJoinCriteriaContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IJoinCriteriaContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
