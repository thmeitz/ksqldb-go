...
// IIntervalClauseContext is an autogenerated mock type for the IIntervalClauseContext type
type IIntervalClauseContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IIntervalClauseContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IIntervalClauseContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IIntervalClauseContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IIntervalClauseContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IIntervalClauseContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IIntervalClauseContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IIntervalClauseContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IIntervalClauseContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) GetText() string {
	ret := _m.Called()
...
func (_m *IIntervalClauseContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsIntervalClauseContext provides a mock function with given fields:
func (_m *IIntervalClauseContext) IsIntervalClauseContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IIntervalClauseContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IIntervalClauseContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IIntervalClauseContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IIntervalClauseContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IIntervalClauseContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IIntervalClauseContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IIntervalClauseContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IIntervalClauseContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IIntervalClauseContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
