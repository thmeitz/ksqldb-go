...
// IWithinExpressionContext is an autogenerated mock type for the IWithinExpressionContext type
type IWithinExpressionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IWithinExpressionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IWithinExpressionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IWithinExpressionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IWithinExpressionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IWithinExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IWithinExpressionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IWithinExpressionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IWithinExpressionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) GetText() string {
	ret := _m.Called()
...
func (_m *IWithinExpressionContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsWithinExpressionContext provides a mock function with given fields:
func (_m *IWithinExpressionContext) IsWithinExpressionContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IWithinExpressionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IWithinExpressionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IWithinExpressionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IWithinExpressionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IWithinExpressionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IWithinExpressionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IWithinExpressionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IWithinExpressionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IWithinExpressionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
