...
// IBooleanExpressionContext is an autogenerated mock type for the IBooleanExpressionContext type
type IBooleanExpressionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IBooleanExpressionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IBooleanExpressionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IBooleanExpressionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IBooleanExpressionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IBooleanExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IBooleanExpressionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IBooleanExpressionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IBooleanExpressionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) GetText() string {
	ret := _m.Called()
...
// IsBooleanExpressionContext provides a mock function with given fields:
func (_m *IBooleanExpressionContext) IsBooleanExpressionContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IBooleanExpressionContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IBooleanExpressionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IBooleanExpressionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IBooleanExpressionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IBooleanExpressionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IBooleanExpressionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IBooleanExpressionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IBooleanExpressionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IBooleanExpressionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IBooleanExpressionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
