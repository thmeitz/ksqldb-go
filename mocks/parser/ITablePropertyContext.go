...
// ITablePropertyContext is an autogenerated mock type for the ITablePropertyContext type
type ITablePropertyContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ITablePropertyContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ITablePropertyContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ITablePropertyContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ITablePropertyContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ITablePropertyContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ITablePropertyContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ITablePropertyContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ITablePropertyContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) GetText() string {
	ret := _m.Called()
...
func (_m *ITablePropertyContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsTablePropertyContext provides a mock function with given fields:
func (_m *ITablePropertyContext) IsTablePropertyContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ITablePropertyContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ITablePropertyContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ITablePropertyContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ITablePropertyContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ITablePropertyContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ITablePropertyContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ITablePropertyContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ITablePropertyContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ITablePropertyContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
