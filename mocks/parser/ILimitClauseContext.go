...
// ILimitClauseContext is an autogenerated mock type for the ILimitClauseContext type
type ILimitClauseContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ILimitClauseContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ILimitClauseContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ILimitClauseContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ILimitClauseContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ILimitClauseContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ILimitClauseContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ILimitClauseContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ILimitClauseContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) GetText() string {
	ret := _m.Called()
...
func (_m *ILimitClauseContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsLimitClauseContext provides a mock function with given fields:
func (_m *ILimitClauseContext) IsLimitClauseContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ILimitClauseContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ILimitClauseContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ILimitClauseContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ILimitClauseContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ILimitClauseContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ILimitClauseContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ILimitClauseContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ILimitClauseContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ILimitClauseContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
