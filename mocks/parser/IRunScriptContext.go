...
// IRunScriptContext is an autogenerated mock type for the IRunScriptContext type
type IRunScriptContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IRunScriptContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IRunScriptContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IRunScriptContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IRunScriptContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IRunScriptContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IRunScriptContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IRunScriptContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IRunScriptContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IRunScriptContext) GetText() string {
	ret := _m.Called()
...
func (_m *IRunScriptContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsRunScriptContext provides a mock function with given fields:
func (_m *IRunScriptContext) IsRunScriptContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IRunScriptContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IRunScriptContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IRunScriptContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IRunScriptContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IRunScriptContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IRunScriptContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IRunScriptContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IRunScriptContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IRunScriptContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
