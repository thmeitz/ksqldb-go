...
// IAssertStatementContext is an autogenerated mock type for the IAssertStatementContext type
type IAssertStatementContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IAssertStatementContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IAssertStatementContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IAssertStatementContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IAssertStatementContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IAssertStatementContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IAssertStatementContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IAssertStatementContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IAssertStatementContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) GetText() string {
	ret := _m.Called()
...
// IsAssertStatementContext provides a mock function with given fields:
func (_m *IAssertStatementContext) IsAssertStatementContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IAssertStatementContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IAssertStatementContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IAssertStatementContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IAssertStatementContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IAssertStatementContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IAssertStatementContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IAssertStatementContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IAssertStatementContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IAssertStatementContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IAssertStatementContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
