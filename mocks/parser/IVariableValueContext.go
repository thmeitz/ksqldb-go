...
// IVariableValueContext is an autogenerated mock type for the IVariableValueContext type
type IVariableValueContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IVariableValueContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IVariableValueContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IVariableValueContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IVariableValueContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IVariableValueContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IVariableValueContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IVariableValueContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IVariableValueContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IVariableValueContext) GetText() string {
	ret := _m.Called()
...
func (_m *IVariableValueContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsVariableValueContext provides a mock function with given fields:
func (_m *IVariableValueContext) IsVariableValueContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IVariableValueContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IVariableValueContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IVariableValueContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IVariableValueContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IVariableValueContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IVariableValueContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IVariableValueContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IVariableValueContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IVariableValueContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
