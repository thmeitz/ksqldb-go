...
// INumberContext is an autogenerated mock type for the INumberContext type
type INumberContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *INumberContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *INumberContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *INumberContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *INumberContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *INumberContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *INumberContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *INumberContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *INumberContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *INumberContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *INumberContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *INumberContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *INumberContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *INumberContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *INumberContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *INumberContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *INumberContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *INumberContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *INumberContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *INumberContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *INumberContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *INumberContext) GetText() string {
	ret := _m.Called()
...
func (_m *INumberContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsNumberContext provides a mock function with given fields:
func (_m *INumberContext) IsNumberContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *INumberContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *INumberContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *INumberContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *INumberContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *INumberContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *INumberContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *INumberContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *INumberContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *INumberContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
