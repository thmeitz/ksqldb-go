...
// ISingleStatementContext is an autogenerated mock type for the ISingleStatementContext type
type ISingleStatementContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ISingleStatementContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ISingleStatementContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ISingleStatementContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ISingleStatementContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ISingleStatementContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ISingleStatementContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ISingleStatementContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ISingleStatementContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) GetText() string {
	ret := _m.Called()
...
func (_m *ISingleStatementContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsSingleStatementContext provides a mock function with given fields:
func (_m *ISingleStatementContext) IsSingleStatementContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ISingleStatementContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ISingleStatementContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ISingleStatementContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ISingleStatementContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ISingleStatementContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ISingleStatementContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ISingleStatementContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ISingleStatementContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ISingleStatementContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
