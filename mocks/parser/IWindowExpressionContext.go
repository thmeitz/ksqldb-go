...
// IWindowExpressionContext is an autogenerated mock type for the IWindowExpressionContext type
type IWindowExpressionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IWindowExpressionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IWindowExpressionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IWindowExpressionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IWindowExpressionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IWindowExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IWindowExpressionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IWindowExpressionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IWindowExpressionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) GetText() string {
	ret := _m.Called()
...
func (_m *IWindowExpressionContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsWindowExpressionContext provides a mock function with given fields:
func (_m *IWindowExpressionContext) IsWindowExpressionContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IWindowExpressionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IWindowExpressionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IWindowExpressionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IWindowExpressionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IWindowExpressionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IWindowExpressionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IWindowExpressionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IWindowExpressionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IWindowExpressionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
