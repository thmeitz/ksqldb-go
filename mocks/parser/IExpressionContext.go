...
// IExpressionContext is an autogenerated mock type for the IExpressionContext type
type IExpressionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IExpressionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IExpressionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IExpressionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IExpressionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IExpressionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IExpressionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IExpressionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IExpressionContext) GetText() string {
	ret := _m.Called()
...
func (_m *IExpressionContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsExpressionContext provides a mock function with given fields:
func (_m *IExpressionContext) IsExpressionContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IExpressionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IExpressionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IExpressionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IExpressionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IExpressionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IExpressionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IExpressionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IExpressionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IExpressionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
