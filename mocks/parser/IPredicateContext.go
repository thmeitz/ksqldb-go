...
// IPredicateContext is an autogenerated mock type for the IPredicateContext type
type IPredicateContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IPredicateContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IPredicateContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IPredicateContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IPredicateContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IPredicateContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IPredicateContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IPredicateContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IPredicateContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetText() string {
	ret := _m.Called()
...
func (_m *IPredicateContext) GetValue() antlr.ParserRuleContext {
	ret := _m.Called()

	var r0 antlr.ParserRuleContext
	if rf, ok := ret.Get(0).(func() antlr.ParserRuleContext); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(antlr.ParserRuleContext)
		}
	}
...
func (_m *IPredicateContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsPredicateContext provides a mock function with given fields:
func (_m *IPredicateContext) IsPredicateContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IPredicateContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IPredicateContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IPredicateContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IPredicateContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IPredicateContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IPredicateContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IPredicateContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetValue provides a mock function with given fields: _a0
func (_m *IPredicateContext) SetValue(_a0 antlr.ParserRuleContext) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IPredicateContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IPredicateContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
