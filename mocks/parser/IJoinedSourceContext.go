...
// IJoinedSourceContext is an autogenerated mock type for the IJoinedSourceContext type
type IJoinedSourceContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IJoinedSourceContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IJoinedSourceContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IJoinedSourceContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IJoinedSourceContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IJoinedSourceContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IJoinedSourceContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IJoinedSourceContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IJoinedSourceContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) GetText() string {
	ret := _m.Called()
...
func (_m *IJoinedSourceContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsJoinedSourceContext provides a mock function with given fields:
func (_m *IJoinedSourceContext) IsJoinedSourceContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IJoinedSourceContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IJoinedSourceContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IJoinedSourceContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IJoinedSourceContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IJoinedSourceContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IJoinedSourceContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IJoinedSourceContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IJoinedSourceContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IJoinedSourceContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
