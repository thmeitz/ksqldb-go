...
// IPartitionByContext is an autogenerated mock type for the IPartitionByContext type
type IPartitionByContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IPartitionByContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IPartitionByContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IPartitionByContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IPartitionByContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IPartitionByContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IPartitionByContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IPartitionByContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IPartitionByContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IPartitionByContext) GetText() string {
	ret := _m.Called()
...
func (_m *IPartitionByContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsPartitionByContext provides a mock function with given fields:
func (_m *IPartitionByContext) IsPartitionByContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IPartitionByContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IPartitionByContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IPartitionByContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IPartitionByContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IPartitionByContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IPartitionByContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IPartitionByContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IPartitionByContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IPartitionByContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
