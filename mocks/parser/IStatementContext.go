...
// IStatementContext is an autogenerated mock type for the IStatementContext type
type IStatementContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IStatementContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IStatementContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IStatementContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IStatementContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IStatementContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IStatementContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IStatementContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IStatementContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IStatementContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IStatementContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IStatementContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IStatementContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IStatementContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IStatementContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IStatementContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IStatementContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IStatementContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IStatementContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IStatementContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IStatementContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IStatementContext) GetText() string {
	ret := _m.Called()
...
func (_m *IStatementContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsStatementContext provides a mock function with given fields:
func (_m *IStatementContext) IsStatementContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IStatementContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IStatementContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IStatementContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IStatementContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IStatementContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IStatementContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IStatementContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IStatementContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IStatementContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
