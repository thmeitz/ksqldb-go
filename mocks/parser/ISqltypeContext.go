...
// ISqltypeContext is an autogenerated mock type for the ISqltypeContext type
type ISqltypeContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ISqltypeContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ISqltypeContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ISqltypeContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ISqltypeContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ISqltypeContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ISqltypeContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ISqltypeContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ISqltypeContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ISqltypeContext) GetText() string {
	ret := _m.Called()
...
func (_m *ISqltypeContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsSqltypeContext provides a mock function with given fields:
func (_m *ISqltypeContext) IsSqltypeContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ISqltypeContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ISqltypeContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ISqltypeContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ISqltypeContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ISqltypeContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ISqltypeContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ISqltypeContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ISqltypeContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ISqltypeContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
