...
// ISelectItemContext is an autogenerated mock type for the ISelectItemContext type
type ISelectItemContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *ISelectItemContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *ISelectItemContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *ISelectItemContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *ISelectItemContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *ISelectItemContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *ISelectItemContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *ISelectItemContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *ISelectItemContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *ISelectItemContext) GetText() string {
	ret := _m.Called()
...
func (_m *ISelectItemContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsSelectItemContext provides a mock function with given fields:
func (_m *ISelectItemContext) IsSelectItemContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *ISelectItemContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *ISelectItemContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *ISelectItemContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *ISelectItemContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *ISelectItemContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *ISelectItemContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *ISelectItemContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *ISelectItemContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *ISelectItemContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
