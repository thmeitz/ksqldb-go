...
// IHoppingWindowExpressionContext is an autogenerated mock type for the IHoppingWindowExpressionContext type
type IHoppingWindowExpressionContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IHoppingWindowExpressionContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IHoppingWindowExpressionContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IHoppingWindowExpressionContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IHoppingWindowExpressionContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IHoppingWindowExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IHoppingWindowExpressionContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IHoppingWindowExpressionContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IHoppingWindowExpressionContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) GetText() string {
	ret := _m.Called()
...
func (_m *IHoppingWindowExpressionContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsHoppingWindowExpressionContext provides a mock function with given fields:
func (_m *IHoppingWindowExpressionContext) IsHoppingWindowExpressionContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IHoppingWindowExpressionContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IHoppingWindowExpressionContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IHoppingWindowExpressionContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IHoppingWindowExpressionContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IHoppingWindowExpressionContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IHoppingWindowExpressionContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IHoppingWindowExpressionContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IHoppingWindowExpressionContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IHoppingWindowExpressionContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
